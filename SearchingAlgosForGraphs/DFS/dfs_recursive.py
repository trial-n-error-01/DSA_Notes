...
class RecursiveDFS:
    ...
    def dfs_recursive(self, current: Node) -> None:
        ...
        for neighbor in neighbors:
            if neighbor not in self.visited:
                print(f"Recursively visiting {neighbor}")
